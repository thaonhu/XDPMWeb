...
namespace DemoAdminPPP.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "image_id,image_name,product_id")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "image_id,image_name,product_id")] Image image)
        {
            if (ModelState.IsValid)
            {
